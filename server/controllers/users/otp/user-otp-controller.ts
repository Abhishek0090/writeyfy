...
export const InsertEmailOtp = (req: Request, res: Response) => {
  ...
  const q =
    "INSERT INTO user_email_otp (`email` , `otp` , `generation`  , `expiry`) VALUES (?)";
...
export const InsertMobileOtp = (req: Request, res: Response) => {
  ...
  const q =
    "INSERT INTO user_number_otp (`number` , `otp` , `generation`  , `expiry`) VALUES (?)";
...
export const verifyEmail = (req: Request, res: Response) => {
  const q = "SELECT * FROM user_email_otp WHERE email =? ORDER BY id DESC LIMIT 1";
...
export const verifyNumber = (req: Request, res: Response) => {
  const q = "SELECT * FROM user_number_otp WHERE number =? ORDER BY id DESC LIMIT 1";
