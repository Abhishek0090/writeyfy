...
import handwrittenImg from "~/assets/written.png";
import TechnicalDrawingImg from "~/assets/drawing.png";
import ArtCraftImg from "~/assets/art.png";
...
const Writer = () => {
  ...
  return (
    <>
      ...
      <p className="text-black-500 text-sm md:text-xl font-medium text-center max-w-[20rem] pt-2 md:max-w-xl mx-auto">
        Pick up Category
      </p>
