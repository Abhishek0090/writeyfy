  ...
  return (
    <Card extra={"w-full h-full p-4 sm:overflow-x-auto"}>
      <div className="relative flex items-center justify-between">
        <div className="text-xl font-bold text-navy-700 dark:text-white">Assignments</div>
        {/* <CardMenu /> */}
      </div>
              ...
              return (
                <tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    let data = "";
                    if (cell.column.Header === "Assignment ID") {
                      data = (
                        <p className="text-sm ml-9 font-bold text-navy-700 dark:text-white">
                          {cell.value}
                        </p>
                      );
                    ...
                    } else if (cell.column.Header === "WRITER NAME") {
                      data = (
                        <p className="text-sm font-bold text-navy-700 dark:text-white">
                          {cell.value}
                        </p>
                      ...
                      data = (
                        <Link to="/admin/assignments/details">
